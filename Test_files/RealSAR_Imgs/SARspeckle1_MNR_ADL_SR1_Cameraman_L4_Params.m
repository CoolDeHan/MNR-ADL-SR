% This file demonstrates how to call the MNR_ADL_SR1 algorithm to remove
...
for ii = 1:AL_iters   
    ...
    max_Cham_iters = 20;
    [M_square_tv,px,py]= chambolle_prox_TV(B2_square+Y_square, ...
        'lambda', lambda2/gamma2, 'maxiter', max_Cham_iters, 'dualvars',[px py]);
    M= im2col(M_square_tv,[n,n],'sliding');
...
% save results
filename = 'RealSAR_Speckle1_MNR_ADL_SR1_Cameraman_L4_Params';
